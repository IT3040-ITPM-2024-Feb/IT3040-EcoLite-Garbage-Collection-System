...
const EditCompanyModal = ({ visible, onCancel, userId, userData, onUpdate }) => {
    ...
    return (
      ...
      >
        <Form form={form} onFinish={onFinish} layout="vertical" style={{height:"535px"}}>
          <Form.Item
            name="companyName"
            label="Company Name"
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: "Please enter the company slogan" }]}
          >
            <Input />
          </Form.Item>
